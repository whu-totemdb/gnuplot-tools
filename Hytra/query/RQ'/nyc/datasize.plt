...
set output "RQ'-datasize-nyc.eps"
set size 0.5,0.5
set origin 0.0, 0.0
set key top left
...
set yrange [0:1200]
plot "datasize-nyc.dat" u 1:2 w lp lw 3  pt 2 ps 1.3 t "Hytra", "datasize-nyc.dat" u 1:3 w lp lw 3  pt 1 ps 1.3 t "Torch", "datasize-nyc.dat" u 1:4 w lp lw 3  pt 4 ps 1.3 t "TrajMesa", "datasize-nyc.dat" u 1:5 w lp lw 3  pt 5 ps 1.3 t "R-Tree" 
